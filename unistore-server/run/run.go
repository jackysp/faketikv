...
var (
	configPath    = flag.String("unistore-config", "", "config file path")
	...
	logFile       = flag.String("unistore-log-file", "", "log file")
	configCheck   = flagBoolean("unistore-config-check", false, "check config file validity and exit")
)
...
func UniStore(wgs ...*sync.WaitGroup) {
